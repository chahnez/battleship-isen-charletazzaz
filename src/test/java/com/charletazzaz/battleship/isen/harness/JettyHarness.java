package com.charletazzaz.battleship.isen.harness;
...
import com.charletazzaz.battleship.isen.GameServlet;
...
public class JettyHarness {
    ...
    public static void startServer() throws Exception {
        ...
        context.addServlet(new ServletHolder(new GameServlet()),
                SERVLET_PATH);
